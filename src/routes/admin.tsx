        ...
        <div className="min-h-screen">
          ...
          <main className="container mx-auto px-4 py-12">
            ...
            <p className="text-muted-foreground mt-2">
              Gestiona cursos, contenido, ruleta, videoconferencias, analítica y anuncios.
            </p>
              ...
              {[
                {
                  ...
                  desc: "Tabla con alta, último acceso, acciones y bloqueo.",
                  to: "/admin/users",
                  ready: true,
                },
                {
                  icon: BookOpenCheck,
                  title: "Matrículas",
                  desc: "Ver alumnos por curso, matricular manualmente y quitar accesos.",
                ...
                },
                {
                  ...
                  desc: "Instagram y TikTok Ads (próximamente).",
                  to: "/admin",
                },
              ].map((card) => (
                <Link
                  key={card.title}
                  to={card.to}
                  className="rounded-2xl border bg-card p-6 hover:-translate-y-1 transition shadow-[var(--shadow-soft)]"
                >
                  ...
                  <span className="inline-block mt-3 text-xs font-semibold text-primary">
                    {(card as any).ready ? "Abrir →" : "Próximamente"}
                  </span>
                </Link>
              ))}
            </div>
